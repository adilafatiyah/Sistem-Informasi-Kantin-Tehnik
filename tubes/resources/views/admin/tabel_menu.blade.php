...
<section class="content">
    <div class="container-fluid">
                <div class="card-body table-responsive p-0">
                            ...
                            <a class="btn btn-block btn-primary" href="/tambah_menu">Tambah Menu</a>
                    ...
                    <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a type="button" href="{{url('/edit', $data->id) }}" class="btn btn-warning">Ubah Menu</a>
                                </td>
                                <td>
                                ...
                                <div class="modal fade" id="exampleModal{{$loop->iteration}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <a href="/hapus_menu/{{$data->id}} }}"><button type="button" class="btn btn-danger">Hapus</button></a>
