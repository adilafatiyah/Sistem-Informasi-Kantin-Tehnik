...
<section class="about" id="about">
  ...
  <div class="block bg-primary block-pd-lg block-bg-overlay text-center" data-bg-img="{{asset('user/img/parallax-bg.jpg')}}" data-settings='{"stellar-background-ratio": 0.6}' data-toggle="parallax-bg">
    <h2>
    ...
    <img alt="Bell - A perfect theme" class="gadgets-img hidden-md-down" src="{{asset('user/img/gadgets.png')}}">
  </div>
  <!-- /Parallax -->
  <!-- Features -->
  ...
  <section class="portfolio" id="portfolio">
    ...
    <div class="portfolio-grid">
      <div class="row">
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{asset('user/img/porf-1.jpg')}}">
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{asset('user/img/porf-2.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{asset('user/img/porf-3.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{asset('user/img/porf-4.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
      ...
      <div class="row">
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{asset('user/img/porf-5.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{asset('user/img/porf-6.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{asset('user/img/porf-7.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
        ...
        <div class="col-lg-3 col-sm-6 col-xs-12">
          <div class="card card-block">
            <a href="#"><img alt="" src="{{asset('user/img/porf-8.jpg')}}">
              <div class="portfolio-over">
                <div>
                  <h3 class="card-title">
                    The Dude Rockin'
  ...
  <section class="team" id="team">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-3 col-xs-6">
          <div class="card card-block">
            <a href="#"><img alt="" class="team-img" src="{{asset('user/img/team-1.jpg')}}">
      ...
      <div class="col-sm-3 col-xs-6">
        <div class="card card-block">
          <a href="#"><img alt="" class="team-img" src="{{asset('user/img/team-2.jpg')}}">
              <div class="card-title-wrap">
                <span class="card-title">Sergio Fez</span> <span class="card-text">Art Director</span>
              </div>
    ...
    <div class="col-sm-3 col-xs-6">
      <div class="card card-block">
        <a href="#"><img alt="" class="team-img" src="{{asset('user/img/team-3.jpg')}}">
              <div class="card-title-wrap">
                <span class="card-title">Sergio Fez</span> <span class="card-text">Art Director</span>
              </div>
    ...
    <div class="col-sm-3 col-xs-6">
      <div class="card card-block">
        <a href="#"><img alt="" class="team-img" src="{{asset('user/img/team-4.jpg')}}">
              <div class="card-title-wrap">
                <span class="card-title">Sergio Fez</span> <span class="card-text">Art Director</span>
              </div>
